...
public class SearchCoursePage extends PageObject {
    ...
    public static final Target COURSE_MAIN_TITLE = Target.the("Visible main text if the course exists").located(By.xpath("(//H4[text()='Recursos Automatización Bancolombia'])[1]"));
